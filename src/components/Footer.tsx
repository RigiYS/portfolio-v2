...
export const Footer = () => {
  const socialLinks = [
    ...
    },
    {
      icon: <SiLinkedin />,
      label: "LinkedIn",
      href: "https://linkedin.com/in/muhammad-rigi-yuda-syahrial",
      color: "hover:text-blue-400",
    },
    {
      icon: <SiInstagram />,
      label: "Instagram",
      href: "https://instagram.com/rigiyuda_",
  ...
  return (
    <footer className="relative bg-slate-900 text-slate-300 pt-20 pb-10 overflow-hidden border-t-4 border-amber-500">
      <div
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 mb-16">
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-400 max-w-md mx-auto md:mx-0 font-medium">
              I am always open to project collaborations, technology
              discussions, or just talking about favorite games.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            {socialLinks.map((social, idx) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group relative w-12 h-12 md:w-14 md:h-14 flex items-center justify-center bg-white/5 border border-white/10 rounded-xl transition-all duration-300 hover:-translate-y-2 hover:bg-white/10 hover:border-blue-400 hover:shadow-[0_0_20px_rgba(56,189,248,0.3)]"
              >
                <span
                  className={`text-xl md:text-2xl transition-colors duration-300 ${social.color}`}
                >
                  {social.icon}
                </span>
                ...
                <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-white/30 rounded-tl group-hover:border-blue-400 transition-colors" />
                <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-white/30 rounded-br group-hover:border-blue-400 transition-colors" />
              </a>
            ))}
          </div>
        </div>
