          ...
          <div className="md:col-span-7 space-y-8">
            <div className="bg-white/60 backdrop-blur-md border border-white/60 p-6 rounded-2xl shadow-sm relative overflow-hidden">
              ...
              <p className="text-slate-600 leading-relaxed font-medium mb-4">
                ...
                yang memiliki ambisi besar untuk menjadi{" "}
              ...
              <p className="text-slate-600 leading-relaxed font-medium">
                Selain berkutat dengan kode (React, Laravel), saya juga seorang
                atlet voli. Disiplin di lapangan mengajarkan saya ketahanan
                mental saat <i>debugging</i> error yang sulit. Saya percaya
                bahwa keseimbangan antara logika (coding) dan fisik (olahraga)
                adalah kunci performa tinggi.
              </p>
            </div>
