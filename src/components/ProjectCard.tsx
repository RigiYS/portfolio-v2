...
export const ProjectCard = ({ title, role, desc, tech, rank, stats, image }: ProjectProps) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-slate-200/50 rounded-4xl transform translate-y-4 scale-95 blur-xl transition-all duration-500 group-hover:translate-y-6 group-hover:bg-amber-400/30" />

      {/* 2. CONTAINER UTAMA (Clean Glass Artifact) */}
      <div className="relative flex flex-col h-full bg-white rounded-4xl overflow-hidden border border-white/80 shadow-2xl ring-1 ring-slate-100 transition-all duration-300 group-hover:ring-amber-300">
        ...
        <div className="relative w-full aspect-video overflow-hidden bg-slate-100 group/image">
          ...
          <div className="absolute top-4 right-4 z-30">
             <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-linear-to-br from-amber-300 to-amber-600 flex items-center justify-center shadow-lg border-2 border-white ring-1 ring-amber-200 group-hover:scale-110 transition-transform">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-8 bg-linear-to-t from-slate-900/90 to-transparent z-20 flex items-center justify-between px-4 pb-1">
          ...
          <div className="absolute inset-0 bg-linear-to-b from-transparent via-white/10 to-transparent -translate-y-full group-hover:animate-shine-down pointer-events-none" />
        </div>

        {/* --- CONTENT BODY --- */}
        <div className="relative z-10 flex flex-col grow p-6 bg-linear-to-b from-white via-white to-slate-50/50">
          
          {/* Header Section */}
          <div className="mb-5">
             <div className="flex items-center justify-between mb-2">
                <span className="px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-[9px] font-extrabold tracking-widest text-blue-600 uppercase">
                  {role}
                </span>
                {/* Dekorasi titik */}
             ...
             <h3 className="text-2xl font-heading font-black text-slate-800 leading-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-blue-600 group-hover:to-blue-500 transition-all">
               {title}
             </h3>
          </div>
          ...
          <div className="mt-auto pt-5 border-t border-slate-100">
            ...
            <a href="#" className="group/btn relative block w-full h-12 rounded-xl transition-all duration-200 active:scale-95 hover:-translate-y-1">
               {/* 3D Shadow Bottom */}
               <div className="absolute inset-0 translate-y-1 rounded-xl bg-[#0369a1]" />
               
               {/* Button Face */}
               <div className="absolute inset-0 bg-linear-to-b from-blue-400 to-blue-600 rounded-xl border-t border-white/30 flex items-center justify-center gap-2 shadow-md overflow-hidden group-hover/btn:from-blue-300 group-hover/btn:to-blue-500">
