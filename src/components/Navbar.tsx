...
import { HiHome, HiLightningBolt, HiChip, HiMail, HiUser } from 'react-icons/hi';
        ...
        >
          {navItems.map((item) => (
            ...
            >
              ...
              {/* Icon */}
              <span className={`text-lg md:text-lg transition-transform duration-300 relative z-10 ${hoveredTab === item.id ? 'scale-110 text-amber-500' : ''}`}>
                {item.icon}
              </span>
